...
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (GenreRow) {
            ...
            GenreRow.lookupKey = 'GenreRow';
            function getLookup() {
                return Q.getLookup('GenreRow');
            }
