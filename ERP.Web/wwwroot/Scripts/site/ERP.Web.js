...
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (PersonRow) {
            ...
            PersonRow.lookupKey = 'PersonRow';
            function getLookup() {
                return Q.getLookup('PersonRow');
            }
