...
(function (ERP) {
    ...
    })(BasicSamples = ERP.BasicSamples || (ERP.BasicSamples = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = ERP.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = ERP.Northwind.OrderDetailsEditor;
...
(function (ERP) {
    ...
    })(Northwind = ERP.Northwind || (ERP.Northwind = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    var Northwind;
...
(function (ERP) {
    ...
    (function (test) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'ERP.test.Gender', 'test.Gender');
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    var test;
    (function (test) {
        var GenreForm = /** @class */ (function (_super) {
            ...
            GenreForm.formKey = 'test.Genre';
            return GenreForm;
        }(Serenity.PrefixedContext));
        test.GenreForm = GenreForm;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (GenreRow) {
            ...
            GenreRow.localTextPrefix = 'test.Genre';
            GenreRow.lookupKey = 'test.Genre';
            function getLookup() {
                return Q.getLookup('test.Genre');
            }
            GenreRow.getLookup = getLookup;
            GenreRow.deletePermission = 'test:Genre:GenreDelete';
            GenreRow.insertPermission = 'test:Genre:GenreInsert';
            GenreRow.readPermission = 'test:Genre:GenreRead';
            GenreRow.updatePermission = 'test:Genre:GenreUpdate';
        })(GenreRow = test.GenreRow || (test.GenreRow = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (GenreService) {
            GenreService.baseUrl = 'test/Genre';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(GenreService = test.GenreService || (test.GenreService = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var MoviecastForm = /** @class */ (function (_super) {
            ...
            MoviecastForm.formKey = 'test.Moviecast';
            return MoviecastForm;
        }(Serenity.PrefixedContext));
        test.MoviecastForm = MoviecastForm;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (MoviecastRow) {
            ...
            MoviecastRow.localTextPrefix = 'test.Moviecast';
            MoviecastRow.lookupKey = 'MoviecastRow';
            function getLookup() {
                return Q.getLookup('MoviecastRow');
            }
            MoviecastRow.getLookup = getLookup;
            MoviecastRow.deletePermission = 'test:Moviecast:MoviecastDelete';
            MoviecastRow.insertPermission = 'test:Moviecast:MoviecastInsert';
            MoviecastRow.readPermission = 'test:Moviecast:MoviecastRead';
            MoviecastRow.updatePermission = 'test:Moviecast:MoviecastUpdate';
        })(MoviecastRow = test.MoviecastRow || (test.MoviecastRow = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (MoviecastService) {
            MoviecastService.baseUrl = 'test/Moviecast';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(MoviecastService = test.MoviecastService || (test.MoviecastService = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var MovieForm = /** @class */ (function (_super) {
            ...
            MovieForm.formKey = 'test.Movie';
            return MovieForm;
        }(Serenity.PrefixedContext));
        test.MovieForm = MovieForm;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (MoviegenresRow) {
            ...
            MoviegenresRow.localTextPrefix = 'test.Moviegenres';
            MoviegenresRow.lookupKey = 'MoviegenresRow';
            function getLookup() {
                return Q.getLookup('MoviegenresRow');
            }
            MoviegenresRow.getLookup = getLookup;
            MoviegenresRow.deletePermission = 'test:Moviegenres:MoviegenresDelete';
            MoviegenresRow.insertPermission = 'test:Moviegenres:MoviegenresInsert';
            MoviegenresRow.readPermission = 'test:Moviegenres:MoviegenresRead';
            MoviegenresRow.updatePermission = 'test:Moviegenres:MoviegenresUpdate';
        })(MoviegenresRow = test.MoviegenresRow || (test.MoviegenresRow = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        })(MovieKind = test.MovieKind || (test.MovieKind = {}));
...
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (MovieRow) {
            ...
            MovieRow.localTextPrefix = 'test.Movie';
            MovieRow.lookupKey = 'MovieRow';
            function getLookup() {
                return Q.getLookup('MovieRow');
            }
            MovieRow.getLookup = getLookup;
            MovieRow.deletePermission = 'test:Movie:MovieDelete';
            MovieRow.insertPermission = 'test:Movie:MovieInsert';
            MovieRow.readPermission = 'test:Movie:MovieRead';
            MovieRow.updatePermission = 'test:Movie:MovieUpdate';
        })(MovieRow = test.MovieRow || (test.MovieRow = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (MovieService) {
            MovieService.baseUrl = 'test/Movie';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(MovieService = test.MovieService || (test.MovieService = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var PersonForm = /** @class */ (function (_super) {
            ...
            PersonForm.formKey = 'test.Person';
            return PersonForm;
        }(Serenity.PrefixedContext));
        test.PersonForm = PersonForm;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (PersonRow) {
            ...
            PersonRow.localTextPrefix = 'test.Person';
            PersonRow.lookupKey = 'test.Person';
            function getLookup() {
                return Q.getLookup('test.Person');
            }
            PersonRow.getLookup = getLookup;
            PersonRow.deletePermission = 'test:Person:PersonDelete';
            PersonRow.insertPermission = 'test:Person:PersonInsert';
            PersonRow.readPermission = 'test:Person:PersonRead';
            PersonRow.updatePermission = 'test:Person:PersonUpdate';
        })(PersonRow = test.PersonRow || (test.PersonRow = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        ...
        (function (PersonService) {
            PersonService.baseUrl = 'test/Person';
            [
                'Create',
                'Update',
                'Delete',
        ...
        })(PersonService = test.PersonService || (test.PersonService = {}));
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
...
(function (ERP) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = ERP.LanguageList.getValue;
        if ($.fn['colorbox']) {
...
(function (ERP) {
    ...
    ERP.StaticTextBlock = StaticTextBlock;
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    var Common;
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        ERP.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
    ...
    (function (test) {
        var GenreDialog = /** @class */ (function (_super) {
            ...
            function GenreDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new test.GenreForm(_this.idPrefix);
                return _this;
            }
            GenreDialog.prototype.getFormKey = function () { return test.GenreForm.formKey; };
            GenreDialog.prototype.getIdProperty = function () { return test.GenreRow.idProperty; };
            GenreDialog.prototype.getLocalTextPrefix = function () { return test.GenreRow.localTextPrefix; };
            GenreDialog.prototype.getNameProperty = function () { return test.GenreRow.nameProperty; };
            GenreDialog.prototype.getService = function () { return test.GenreService.baseUrl; };
            GenreDialog.prototype.getDeletePermission = function () { return test.GenreRow.deletePermission; };
            GenreDialog.prototype.getInsertPermission = function () { return test.GenreRow.insertPermission; };
            GenreDialog.prototype.getUpdatePermission = function () { return test.GenreRow.updatePermission; };
            GenreDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], GenreDialog);
            return GenreDialog;
        }(Serenity.EntityDialog));
        test.GenreDialog = GenreDialog;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var GenreGrid = /** @class */ (function (_super) {
            ...
            GenreGrid.prototype.getColumnsKey = function () { return 'test.Genre'; };
            GenreGrid.prototype.getDialogType = function () { return test.GenreDialog; };
            GenreGrid.prototype.getIdProperty = function () { return test.GenreRow.idProperty; };
            GenreGrid.prototype.getInsertPermission = function () { return test.GenreRow.insertPermission; };
            GenreGrid.prototype.getLocalTextPrefix = function () { return test.GenreRow.localTextPrefix; };
            GenreGrid.prototype.getService = function () { return test.GenreService.baseUrl; };
            GenreGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], GenreGrid);
            return GenreGrid;
        }(Serenity.EntityGrid));
        test.GenreGrid = GenreGrid;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var GenreListFormatter = /** @class */ (function () {
            ...
            GenreListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = test.GenreRow.getLookup().itemById;
        ...
        test.GenreListFormatter = GenreListFormatter;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var MovieDialog = /** @class */ (function (_super) {
            ...
            function MovieDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new test.MovieForm(_this.idPrefix);
                return _this;
            }
            MovieDialog.prototype.getFormKey = function () { return test.MovieForm.formKey; };
            MovieDialog.prototype.getIdProperty = function () { return test.MovieRow.idProperty; };
            MovieDialog.prototype.getLocalTextPrefix = function () { return test.MovieRow.localTextPrefix; };
            MovieDialog.prototype.getNameProperty = function () { return test.MovieRow.nameProperty; };
            MovieDialog.prototype.getService = function () { return test.MovieService.baseUrl; };
            MovieDialog.prototype.getDeletePermission = function () { return test.MovieRow.deletePermission; };
            MovieDialog.prototype.getInsertPermission = function () { return test.MovieRow.insertPermission; };
            MovieDialog.prototype.getUpdatePermission = function () { return test.MovieRow.updatePermission; };
            MovieDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], MovieDialog);
            return MovieDialog;
        }(Serenity.EntityDialog));
        test.MovieDialog = MovieDialog;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var MovieGrid = /** @class */ (function (_super) {
            ...
            MovieGrid.prototype.getColumnsKey = function () { return 'test.Movie'; };
            MovieGrid.prototype.getDialogType = function () { return test.MovieDialog; };
            MovieGrid.prototype.getIdProperty = function () { return test.MovieRow.idProperty; };
            MovieGrid.prototype.getInsertPermission = function () { return test.MovieRow.insertPermission; };
            MovieGrid.prototype.getLocalTextPrefix = function () { return test.MovieRow.localTextPrefix; };
            MovieGrid.prototype.getService = function () { return test.MovieService.baseUrl; };
    ...
    (function (test) {
        var MovieCastEditDialog = /** @class */ (function (_super) {
            ...
            function MovieCastEditDialog() {
                var _this = _super.call(this) || this;
                _this.form = new test.MoviecastForm(_this.idPrefix);
                return _this;
            }
            MovieCastEditDialog.prototype.getFormKey = function () { return test.MoviecastForm.formKey; };
            MovieCastEditDialog.prototype.getNameProperty = function () { return test.MoviecastRow.nameProperty; };
            MovieCastEditDialog.prototype.getLocalTextPrefix = function () { return test.MoviecastRow.localTextPrefix; };
            MovieCastEditDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], MovieCastEditDialog);
            return MovieCastEditDialog;
        }(ERP.Common.GridEditorDialog));
        test.MovieCastEditDialog = MovieCastEditDialog;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var MovieCastEditor = /** @class */ (function (_super) {
            ...
            MovieCastEditor.prototype.getColumnsKey = function () { return "test.Moviecast"; };
            MovieCastEditor.prototype.getDialogType = function () { return test.MovieCastEditDialog; };
            MovieCastEditor.prototype.getLocalTextPrefix = function () { return test.MoviecastRow.localTextPrefix; };
            MovieCastEditor.prototype.validateEntity = function (row, id) {
                if (!_super.prototype.validateEntity.call(this, row, id))
                    return false;
                row.PersonFullname = test.PersonRow.getLookup()
        ...
        test.MovieCastEditor = MovieCastEditor;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var PersonDialog = /** @class */ (function (_super) {
            ...
            function PersonDialog() {
                var _this = _super.call(this) || this;
                _this.form = new test.PersonForm(_this.idPrefix);
                _this.moviesGrid = new test.PersonMovieGrid(_this.byId("MoviesGrid"));
                _this.tabs.on('tabsactivate', function (e, i) {
                    _this.arrange();
                });
                return _this;
            }
            PersonDialog.prototype.getFormKey = function () { return test.PersonForm.formKey; };
            PersonDialog.prototype.getIdProperty = function () { return test.PersonRow.idProperty; };
            PersonDialog.prototype.getLocalTextPrefix = function () { return test.PersonRow.localTextPrefix; };
            PersonDialog.prototype.getNameProperty = function () { return test.PersonRow.nameProperty; };
            PersonDialog.prototype.getService = function () { return test.PersonService.baseUrl; };
            PersonDialog.prototype.getDeletePermission = function () { return test.PersonRow.deletePermission; };
            PersonDialog.prototype.getInsertPermission = function () { return test.PersonRow.insertPermission; };
            PersonDialog.prototype.getUpdatePermission = function () { return test.PersonRow.updatePermission; };
        ...
        test.PersonDialog = PersonDialog;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var PersonGrid = /** @class */ (function (_super) {
            ...
            PersonGrid.prototype.getColumnsKey = function () { return 'test.Person'; };
            PersonGrid.prototype.getDialogType = function () { return test.PersonDialog; };
            PersonGrid.prototype.getIdProperty = function () { return test.PersonRow.idProperty; };
            PersonGrid.prototype.getInsertPermission = function () { return test.PersonRow.insertPermission; };
            PersonGrid.prototype.getLocalTextPrefix = function () { return test.PersonRow.localTextPrefix; };
            PersonGrid.prototype.getService = function () { return test.PersonService.baseUrl; };
            PersonGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], PersonGrid);
            return PersonGrid;
        }(Serenity.EntityGrid));
        test.PersonGrid = PersonGrid;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
    ...
    (function (test) {
        var PersonMovieGrid = /** @class */ (function (_super) {
            ...
            PersonMovieGrid.prototype.getColumnsKey = function () { return "test.PersonMovie"; };
            PersonMovieGrid.prototype.getIdProperty = function () { return test.MoviecastRow.idProperty; };
            PersonMovieGrid.prototype.getLocalTextPrefix = function () { return test.MoviecastRow.localTextPrefix; };
            PersonMovieGrid.prototype.getService = function () { return test.MoviecastService.baseUrl; };
        ...
        test.PersonMovieGrid = PersonMovieGrid;
    })(test = ERP.test || (ERP.test = {}));
})(ERP || (ERP = {}));
var ERP;
(function (ERP) {
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: ERP.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: ERP.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new ERP.Northwind.OrderDialog();
                        ...
                        var chai = ERP.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = ERP.Northwind.EmployeeRow.getLookup().items
        ...
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    ERP.Northwind.CategoryService.Retrieve({
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(ERP.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new ERP.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                ERP.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(ERP.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    ERP.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(ERP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(ERP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    ERP.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return ERP.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return ERP.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return ERP.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return ERP.Northwind.OrderService.baseUrl; };
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return ERP.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return ERP.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return ERP.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return ERP.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return ERP.Northwind.OrderService.baseUrl; };
        ...
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    ERP.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = ERP.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return ERP.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return ERP.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new ERP.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(ERP.Northwind.OrderDetailDialog));
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        ...
        }(ERP.Northwind.OrderDetailsEditor));
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return ERP.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return ERP.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return ERP.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return ERP.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return ERP.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return ERP.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return ERP.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return ERP.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return ERP.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(ERP.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new ERP.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new ERP.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new ERP.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (ERP) {
    ...
    ERP.SelectableEntityGrid = SelectableEntityGrid;
})(ERP || (ERP = {}));
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return ERP.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return ERP.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return ERP.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return ERP.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(ERP.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = ERP.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            ERP.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return ERP.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return ERP.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return ERP.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return ERP.Northwind.ProductService.baseUrl; };
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return ERP.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return ERP.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return ERP.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return ERP.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return ERP.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return ERP.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (ERP) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return ERP.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return ERP.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return ERP.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
