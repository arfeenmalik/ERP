    ...
    declare namespace Db {
        ...
        namespace test {
            ...
            namespace Moviecast {
                ...
                export const Movieid: string;
                export const MovieidDescription: string;
                export const MovieidKind: string;
                export const MovieidReleasedate: string;
                export const MovieidRuntime: string;
                export const MovieidStoryline: string;
                export const MovieidTitle: string;
                export const MovieidYear: string;
                export const PersonFullname: string;
                export const Personid: string;
                export const PersonidBirthdate: string;
                export const PersonidBirthplace: string;
                export const PersonidFirstname: string;
                export const PersonidGender: string;
                export const PersonidHeight: string;
                export const PersonidLastname: string;
            }

            namespace Moviegenres {
                export const Genreid: string;
                export const GenreidName: string;
